...
- Does verification evidence match the Unity surfaces changed: compile, console, EditMode, PlayMode, scene smoke, prefab smoke, MCPForUnity target, or explicit limitation?
