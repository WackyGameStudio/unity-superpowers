...
1. **Create Failing Test Case**
   ...
   - Use the `test-driven-development-unity` skill for writing proper failing tests
...
**Related skills:**
- **test-driven-development-unity** - For creating failing test case (Phase 4, Step 1)
- **verification-before-completion-unity** - Verify fix worked before claiming success
