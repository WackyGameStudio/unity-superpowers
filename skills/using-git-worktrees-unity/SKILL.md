---
name: using-git-worktrees-unity
...
**Announce at start:** "I'm using the using-git-worktrees-unity skill to set up an isolated workspace."
...
- Use `git worktree add` when you have a native worktree tool (e.g., `EnterWorktree`). This is the #1 mistake: if you have the native tool, use it.
