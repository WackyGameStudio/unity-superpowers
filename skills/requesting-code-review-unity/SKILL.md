---
name: requesting-code-review-unity
...
## Unity Review Surface

Review code and Unity artifacts together:

- MonoBehaviour responsibility boundaries
- interface size and capability segregation
- State, Strategy, factory, observer/event, and ScriptableObject usage
...
See template at: requesting-code-review-unity/code-reviewer.md
